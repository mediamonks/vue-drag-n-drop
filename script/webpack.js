...
umd.output.filename = "./dist/vue-drag-n-drop-umd.js";

var umdMin = baseConfig();
umdMin.output.libraryTarget = "umd";
umdMin.output.filename = "./dist/vue-drag-n-drop-umd.min.js";
...
amd.output.filename = "./dist/vue-drag-n-drop-amd.js";


var cjs2 = baseConfig();
delete cjs2.output.library;
cjs2.output.libraryTarget = "commonjs2";
cjs2.output.filename = "./dist/vue-drag-n-drop-commonjs.js";
...
system.plugins.push(
	...
	new WebpackSystemRegister({
		...
		registerName: 'vue-drag-n-drop', // optional name that SystemJS will know this bundle as.
	})
);
system.output.filename = "./dist/vue-drag-n-drop-systemjs.js";


var browser = baseConfig();
browser.output.libraryTarget = "var";
browser.output.filename = "./dist/vue-drag-n-drop.js";


var browserMin = baseConfig();
browserMin.output.libraryTarget = "var";
browserMin.output.filename = "./dist/vue-drag-n-drop.min.js";
